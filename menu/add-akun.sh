...
echo -e "======CREATE ACC - LENDIRVPN=======" | tee -a /etc/log-create-user.log
...
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | tee -a /etc/log-create-user.log
echo -e "LENDIR VPN" | tee -a /etc/log-create-user.log
echo -e "Whatsapp: 085921690559" | tee -a /etc/log-create-user.log
echo -e "Telegram: Lendir VPN" | tee -a /etc/log-create-user.log
