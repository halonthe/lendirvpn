...
DOMAIN=lendirsosmed.my.id
SUB_DOMAIN=${sub}.lendirsosmed.my.id
NS_DOMAIN=${sub}.lendirsosmed.my.id
CF_ID=halonthe@gmail.com
CF_KEY=9427998d1f8746cd741f2ae89a225e5f55c6c
set -euo pipefail
...
echo "auto pointing set successfully"
